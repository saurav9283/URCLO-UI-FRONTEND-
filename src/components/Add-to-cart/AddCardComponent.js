...
const AddCardComponent = () => {
  return (
    <div className="flex flex-col md:flex-row w-full min-h-screen p-4 bg-gray-50">
      {/* Left Section */}
      <div className="flex flex-col w-full md:w-2/3 bg-white rounded-lg shadow-md p-6 space-y-4">
        <div>
        ...
        <div className="w-full mt-6">
          ...
          <p className="text-purple-600 cursor-pointer mt-2">Read full policy</p>
        </div>
      </div>

      {/* Right Section */}
      <div className="flex flex-col overflow-y-scroll w-full md:w-1/3 max-h-[100vh] bg-white rounded-lg shadow-md mt-4 md:mt-0 md:ml-6 p-6 space-y-4">
        <div className="border-b pb-4">
